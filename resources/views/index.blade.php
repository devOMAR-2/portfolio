...
<html lang="en" dir="ltr">
  ...
  <head>
    ...
    <!-- Meta Tags -->
    <meta name="description" content="Omar Al-Farraj - Software Engineer with 7+ years of experience. Specializing in Laravel, Filament, and mobile app development. Based in Riyadh, Saudi Arabia. Available for freelance projects.">
    <meta name="keywords" content="omar al-farraj, software engineer, laravel developer saudi arabia, full-stack developer riyadh, freelance software engineer, php developer, filament, mobile app development, web development">
    ...
    <meta property="og:title" content="Omar Al-Farraj | Software Engineer">
    <meta property="og:description" content="Software Engineer with 7+ years of experience. Specializing in Laravel, Filament, and mobile app development. Based in Riyadh, Saudi Arabia.">
    <meta property="og:url" content="{{ url('/') }}">
    <meta property="og:image" content="{{ asset('img/favicon/og-image.jpg') }}">
        ...
        <div class="avatar__block">
          <div class="avatar__logo d-flex align-items-center">
            ...
            <div class="logo__caption">
              <p>Omar<br>Al-Farraj</p>
            </div>
          </div>
          <div class="avatar__image">
            <img src="https://dummyimage.com/1024x1024/4d4d4d/ffffff&text=O" alt="Omar Al-Farraj - Software Engineer">
          </div>
        </div>
        <!-- data caption #1 -->
        <div class="avatar__block">
          ...
          <div class="avatar__socials">
            <ul class="socials-square d-flex justify-content-between">
              <li class="socials-square__item">
                <a class="socials-square__link btn" href="https://github.com/devomar-2" target="_blank"><i class="ph-bold ph-github-logo"></i></a>
              </li>
              <li class="socials-square__item">
                <a class="socials-square__link btn" href="https://linkedin.com/in/omar-alfarraj" target="_blank"><i class="ph-bold ph-linkedin-logo"></i></a>
              </li>
              <li class="socials-square__item">
                <a class="socials-square__link btn" href="https://x.com/devomar_" target="_blank"><i class="ph-bold ph-x-logo"></i></a>
              </li>
            </ul>
          </div>
    ...
    <div id="content" class="content">
      <div class="content__wrapper">
        ...
        <section id="home" class="main intro">
          ...
          <div id="headline" class="headline d-flex align-items-start flex-column" data-speed="1">
            ...
            <div class="headline__btnholder d-flex flex-column flex-sm-row">
              ...
              <a class="btn mobile-vertical btn-default btn-hover btn-hover-outline-mobile animate-headline" href="#contact">
              ...
              <div class="row g-0 justify-content-between">
                ...
                <div class="col-12 col-xl-8 grid-item about-descr">
                  <p class="about-descr__text animate-in-up">
                    Hey there! I'm Omar, a Software Engineer based in Riyadh with over 7 years of experience
                    crafting web and mobile applications. I enjoy building things that make a difference,
                  ...
                  <p class="about-descr__text animate-in-up">
                    ...
                    I also offer technical consulting and site audits to help businesses optimize their digital presence.
                    When I'm not coding, you'll find me exploring new technologies or helping fellow developers grow.
                  </p>
                  <div class="btn-group about-descr__btnholder animate-in-up">
                    <a class="btn mobile-vertical btn-default btn-hover btn-hover-accent" href="#contact">
                      <span class="btn-caption">Get In Touch</span>
                      <i class="ph-bold ph-envelope"></i>
                    </a>
                  </div>
                ...
                <div class="col-12 col-xl-4 grid-item about-info">
                  ...
                  <div class="about-info__item animate-in-up">
                    <h6>
                      ...
                      <a class="text-link-bold" href="mailto:hi@devomar.me?subject=Hello%20Omar">hi@devomar.me</a>
                    </h6>
                  </div>
                  <div class="about-info__item animate-in-up">
                    <h6>
                      <small class="top">Location</small>
                      <a class="text-link-bold" href="https://maps.google.com/?q=Riyadh+Saudi+Arabia" target="_blank">Riyadh, Saudi Arabia</a>
                    </h6>
                  </div>
                </div>
                ...
                <div class="col-12 col-md-6 cards__item grid-item animate-card-2">
                  <div class="cards__card d-flex flex-column">
                    <div class="cards__descr">
                      ...
                      <p class="small cards__text animate-in-up">Building robust APIs, database architectures, and server-side applications with Laravel.</p>
                    </div>
                    <div class="cards__image d-flex animate-in-up">
                      <img src="https://dummyimage.com/1200x900/3d5a80/ffffff&text=Backend" alt="Backend Development">
                    </div>
                  </div>
                </div>
                ...
                <div class="col-12 col-md-6 cards__item grid-item animate-card-2">
                  <div class="cards__card d-flex flex-column">
                    <div class="cards__descr">
                      ...
                      <p class="small cards__text animate-in-up">Creating responsive and interactive user interfaces with modern frontend technologies.</p>
                    </div>
                    <div class="cards__image d-flex animate-in-up">
                      <img src="https://dummyimage.com/1200x900/ee6c4d/ffffff&text=Frontend" alt="Frontend Development">
                    </div>
                  </div>
                </div>
                <!-- services grid cards single item -->
                <div class="col-12 col-md-6 cards__item grid-item animate-card-2">
                  <div class="cards__card d-flex flex-column">
                    <div class="cards__descr">
                      ...
                      <p class="small cards__text animate-in-up">Developing powerful admin interfaces and content management systems using Filament.</p>
                    </div>
                    <div class="cards__image d-flex">
                      <img src="https://dummyimage.com/1200x900/293241/ffffff&text=Admin" alt="Admin Panels">
                    </div>
                  </div>
                </div>
                <!-- services grid cards single item -->
                <div class="col-12 col-md-6 cards__item grid-item animate-card-2">
                  <div class="cards__card d-flex flex-column">
                    <div class="cards__descr">
                      ...
                      <p class="small cards__text animate-in-up">Building native and cross-platform mobile applications that deliver seamless user experiences.</p>
                    </div>
                    <div class="cards__image d-flex animate-in-up">
                      <img src="https://dummyimage.com/1200x900/98c1d9/293241&text=Mobile" alt="Mobile App Development">
                    </div>
                  </div>
                </div>
                <!-- services grid cards single item -->
                <div class="col-12 col-md-6 cards__item grid-item animate-card-2">
                  <div class="cards__card d-flex flex-column">
                    <div class="cards__descr">
                      ...
                      <p class="small cards__text animate-in-up">Providing expert guidance on technical decisions, performance optimization, and best practices.</p>
                    </div>
                    <div class="cards__image d-flex animate-in-up">
                      <img src="https://dummyimage.com/1200x900/6c757d/ffffff&text=Consulting" alt="Technical Consulting">
                    </div>
                  </div>
                </div>
        ...
        <section id="resume" class="inner resume">
          ...
          <div class="content__block block-large">
            ...
            <p class="h2__text animate-in-up">
              A dedicated developer with a strong foundation in computer science and years of hands-on experience
          ...
          <div class="content__block block-large">
            ...
            <div class="container-fluid p-0 resume-lines">
              ...
              <div class="row g-0 resume-lines__item animate-in-up">
                ...
                <div class="col-12 col-md-5">
                  <p class="small resume-lines__descr animate-in-up">Advanced studies in software architecture, system design, and modern development practices.</p>
                </div>
              </div>
              <!-- education single item -->
              <div class="row g-0 resume-lines__item animate-in-up">
                ...
                <div class="col-12 col-md-5">
                  <p class="small resume-lines__descr animate-in-up">Foundation in programming fundamentals, database management, and web development.</p>
                </div>
              </div>
            </div>
            <!-- Education Lines End -->
          ...
          <div class="content__block block-large">
            ...
            <div class="container-fluid p-0 resume-lines">
              ...
              <div class="row g-0 resume-lines__item animate-in-up">
                ...
                <div class="col-12 col-md-5">
                  <p class="small resume-lines__descr animate-in-up">Designing and developing enterprise applications, leading technical initiatives, and mentoring junior developers.</p>
                </div>
              </div>
              <!-- experience single item -->
              <div class="row g-0 resume-lines__item animate-in-up">
                ...
                <div class="col-12 col-md-5">
                  <p class="small resume-lines__descr animate-in-up">Building custom web applications, admin panels, and mobile apps for clients across various industries.</p>
                </div>
              </div>
            </div>
            ...
            <div class="tools-cards d-flex justify-content-start flex-wrap">
              ...
              <div class="tools-cards__item d-flex grid-item-s animate-card-5">
                <div class="tools-cards__card">
                  <i class="ph-bold ph-code tools-cards__icon animate-in-up" style="font-size: 2.5rem;"></i>
              ...
              <div class="tools-cards__item d-flex grid-item-s animate-card-5">
                <div class="tools-cards__card">
                  <i class="ph-bold ph-file-php tools-cards__icon animate-in-up" style="font-size: 2.5rem;"></i>
              ...
              <div class="tools-cards__item d-flex grid-item-s animate-card-5">
                <div class="tools-cards__card">
                  <i class="ph-bold ph-database tools-cards__icon animate-in-up" style="font-size: 2.5rem;"></i>
              ...
              <div class="tools-cards__item d-flex grid-item-s animate-card-5">
                <div class="tools-cards__card">
                  <i class="ph-bold ph-file-html tools-cards__icon animate-in-up" style="font-size: 2.5rem;"></i>
              ...
              <div class="tools-cards__item d-flex grid-item-s animate-card-5">
                <div class="tools-cards__card">
                  <i class="ph-bold ph-file-css tools-cards__icon animate-in-up" style="font-size: 2.5rem;"></i>
              ...
              <div class="tools-cards__item d-flex grid-item-s animate-card-5">
                <div class="tools-cards__card">
                  <i class="ph-bold ph-file-js tools-cards__icon animate-in-up" style="font-size: 2.5rem;"></i>
              ...
              <div class="tools-cards__item d-flex grid-item-s animate-card-5">
                <div class="tools-cards__card">
                  <i class="ph-bold ph-wind tools-cards__icon animate-in-up" style="font-size: 2.5rem;"></i>
              ...
              <div class="tools-cards__item d-flex grid-item-s animate-card-5">
                <div class="tools-cards__card">
                  <i class="ph-bold ph-git-branch tools-cards__icon animate-in-up" style="font-size: 2.5rem;"></i>
        ...
        <section id="contact" class="inner contact">
              ...
              <form class="form contact-form" id="contact-form">
                ...
                <div class="container-fluid p-0">
                  <div class="row gx-0">
                    ...
                    <div class="col-12 form__item animate-in-up">
                      <button class="btn btn-default btn-hover btn-hover-accent" type="submit" id="submit-btn">
            ...
            <div class="socials-cards d-flex justify-content-start flex-wrap">
              ...
              <div class="socials-cards__item d-flex grid-item-s animate-card-5">
                <div class="socials-cards__card">
                  ...
                  <a class="socials-cards__link" href="https://github.com/devomar-2" target="_blank"></a>
                </div>
              </div>
              <!-- socials item -->
              <div class="socials-cards__item d-flex grid-item-s animate-card-5">
                <div class="socials-cards__card">
                  ...
                  <a class="socials-cards__link" href="https://linkedin.com/in/omar-alfarraj" target="_blank"></a>
                </div>
              </div>
              <!-- socials item -->
              <div class="socials-cards__item d-flex grid-item-s animate-card-5">
          ...
          <div class="content__block">
            <div class="teaser">
              <p class="teaser__text animate-in-up">Want to know more about me, discuss a project or just say hello?
                <a class="text-link-bold" href="mailto:hi@devomar.me?subject=Hello%20Omar">Drop me a line</a>
              ...
              <div class="row g-0 contact-lines__item">
                ...
                <div class="col-12 col-md-4 contact-lines__data">
                  ...
                  <p class="contact-lines__text animate-in-up">
                    <a class="text-link-bold" href="https://maps.google.com/?q=Saudi+Arabia" target="_blank">Saudi Arabia</a>
                  </p>
                </div>
                <!-- data item -->
                <div class="col-12 col-md-4 contact-lines__data">
                ...
                <div class="col-12 col-md-4 contact-lines__data">
                  ...
                  <p class="contact-lines__text animate-in-up">
                    <a class="text-link-bold" href="mailto:hi@devomar.me?subject=Hello%20Omar">omar.alfarraj@yahoo.com</a>
                  </p>
                </div>
              </div>
            </div>
